    ...
    <main className="min-h-screen overflow-hidden bg-[#0a0a0a] text-white">
      ...
      <header className="fixed left-0 right-0 top-4 z-50 px-5 ">
        <nav
          ...
          className="mx-auto flex h-[50px] max-w-[1400px] items-center justify-between rounded-full border border-white/[0.08] bg-[#2d2d2c]/55 px-2 shadow-[0_8px_32px_rgba(0,0,0,0.45)] backdrop-blur-2xl"
        >
          {/* Logo — far left */}
          <a
            href="#home"
