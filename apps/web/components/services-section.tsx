...
export function ServicesSection() {
  return (
    <section
      ...
      className="bg-[#f9eee4] px-4 pt-10 sm:px-6 sm:pt-18 lg:px-8"
      id="services"
    >
      <div className="mx-auto mb-8 max-w-3xl text-center sm:mb-12">
        ...
        >
          <span className="text-[#9b8d82]">
            <BlurText text="What we do best," delay={160} />
          </span>
          <br />
      ...
      <div className={`${karla.className} mx-auto grid max-w-330 gap-4 md:grid-cols-2 xl:grid-cols-3`}>
        {services.map((service, index) => (
          <Reveal delayMs={index * 55} distance="sm" key={service.number}>
            <article
              className="group relative flex min-h-52 items-start overflow-hidden rounded-[18px] border border-[#ead9c9]/70 bg-[linear-gradient(145deg,#ffffff_0%,#fff8f5_52%,#f3e4d6_100%)] px-6 py-6 shadow-[0_12px_40px_rgba(35,26,18,0.07)] transition-shadow duration-500 ease-in-out hover:shadow-[0_20px_56px_rgba(138,81,0,0.14)] sm:min-h-60 sm:px-7 sm:py-7"
            >
